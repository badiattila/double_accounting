...
class APITests(TestCase):
    ...
    def test_predict_endpoint_fallback(self):
        ...
        resp = self.client.post(
            url,
            {"payee": "AMAZON EU", "narrative": "cables", "amount": "12.99"},
            format="json",
        )
...
class ReportTests(TestCase):
    ...
    def setUp(self):
        ...
        self.bank = Account.objects.create(
            code="1100", name="Bank", type=AccountType.ASSET, normal_debit=True
        )
        self.sales = Account.objects.create(
            code="4000", name="Sales", type=AccountType.INCOME, normal_debit=False
        )
        self.food = Account.objects.create(
            code="5200", name="Food", type=AccountType.EXPENSE, normal_debit=True
        )
